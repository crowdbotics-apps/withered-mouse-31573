...
## Project Structure
    ...
    ├── withered_mouse_31573  # Django project configurations
...
1. Clone this repo and `cd withered_mouse_31573`
...
2. Clone this repo and `cd withered_mouse_31573`
